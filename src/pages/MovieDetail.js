...
export const MovieDetail = () => {
  ...
  useEffect (() => {
    ...
    async function fetchMovie(){
      ...
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=60304cf42166fb98070117fc875a3ddc`);
  ...
  return (
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-left text-gray-700 text-lg dark:text-white">
